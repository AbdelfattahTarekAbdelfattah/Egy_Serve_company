...
import C_image_1 from "./images/caimg.jpg";
import C_image_2 from "./images/img66.jpg";
import C_image_3 from "./images/mal_3.jpg";

const Collection = () => {
  return (
    <section className="Enveloping Express">
      <h2 className="title text-center">Cash Collection</h2>
      <div className="container text-center mt-5">
        <div className="row">
          <div className="col-md-6">
            <img src={C_image_1} alt="" />
          </div>
          <div className="col-md-6">
          ...
          <div className="has-p">
            <p>
              Through this service, the company collects cash in accordance with
              the contracting procedures with the client and deposits the
              collected amounts in the accounts of the contracting parties.
            </p>
          </div>
        </div>
        ...
        <div className="row align-items-center images">
          <div className="col-md-5">
            <img src={C_image_2} alt="" />
          </div>
          <div className="col-md-5">
            <img src={C_image_3} alt="" />
          </div>
        </div>
      </div>
    </section>
