...
import en_1 from './images/en_1.jpg';
import en_2 from './images/en_2.jpg';
import en_3 from './images/en_3.jpg';
const Enveloping = () => {
  return (
    <section className="Enveloping Express">
      <h2 className="title text-center">Enveloping</h2>
      <div className="container text-center mt-5">
        <div className="row">
          ...
          <div className="has-p">
            <p>
              EgyServ owns an automatic enveloping line that uses the latest
              machines in the market, and is operated by experienced workforce
              in this field,enabling the company to process about 600,000
              envelopes per day.
            </p>
          </div>
        </div>
