...
import web_img from './images/webi.jpg';
import web_img_2 from './images/99.jpg';

const InterBranch = () => {
  return (
    <section className="Enveloping Express">
      <h2 className="title text-center">Inter Branch Couriering</h2>
      <div className="container text-center mt-5">
        <div className="row">
          ...
          <div className="has-p">
            <p>
              In order to link the head office to the entire network of banks
              and large companies spread all over the country, EgyServ secure a
              punctual line hauls that allow regular parcels and documents
              deliveries with the highest level of quality and safety standards.
            </p>
          </div>
        </div>
